<?php
    ...
    $query = "CREATE TABLE IF NOT EXISTS Messages (id INTEGER NOT NULL PRIMARY KEY, authorId INT, groupId INT, content STRING, dateSent TIMESTAMP)";
    $db->exec($query);
    ...
    $query = "CREATE TABLE IF NOT EXISTS GroupsParticipants (id INTEGER NOT NULL PRIMARY KEY, groupId INT NOT NULL, userId INT NOT NULL)";
    $db->exec($query);
?>